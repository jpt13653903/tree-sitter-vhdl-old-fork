module.exports = grammar({
    ...
    rules: {
        ...
        function_specification: $ => seq(
            optional(choice($.PURE, $.IMPURE)), $.FUNCTION, $.designator, optional($.subprogram_header), optional(seq(optional($.PARAMETER), $.left_parenthesis, $.formal_parameter_list, $.right_parenthesis)), $.RETURN, optional(seq($.identifier, $.OF)), $.type_mark
        ),
