...
static void register_reserved(TokenTree* token_tree)
{
    ...
    token_tree_insert(token_tree, "assume_guarantee",   RESERVED_ASSUME_GUARANTEE);
    ...
    token_tree_insert(token_tree, "restrict_guarantee", RESERVED_RESTRICT_GUARANTEE);
...
static void register_base_specifiers(TokenTree* token_tree)
{
    ...
    token_tree_insert(token_tree, "ub\"", BASE_SPECIFIER_UNSIGNED_BINARY);
    token_tree_insert(token_tree, "uo\"", BASE_SPECIFIER_UNSIGNED_OCTAL);
    token_tree_insert(token_tree, "ux\"", BASE_SPECIFIER_UNSIGNED_HEX);
    token_tree_insert(token_tree, "sb\"", BASE_SPECIFIER_SIGNED_BINARY);
