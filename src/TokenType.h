...
typedef enum TokenTypeTag{
    ...
    BASE_SPECIFIER_HEX,
    BASE_SPECIFIER_UNSIGNED_BINARY,
    BASE_SPECIFIER_UNSIGNED_OCTAL,
    BASE_SPECIFIER_UNSIGNED_HEX,
    BASE_SPECIFIER_SIGNED_BINARY,
    BASE_SPECIFIER_SIGNED_OCTAL,
    BASE_SPECIFIER_SIGNED_HEX,
